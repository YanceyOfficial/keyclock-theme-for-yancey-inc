...
const { I18nProvider, useI18n } = i18nBuilder
    ...
    .withCustomTranslations({
        en: {
            welcomeMessage:
                "We will provide you with secure and reliable authentication and authorization related services",
        ...
        ar: {
            welcomeMessage: "مرحبًا بك في Yancey inc - بوابتك إلى التخطيط والتنظيم السلس.",
        ...
        fr: {
            welcomeMessage:
                "Bienvenue sur Yancey inc Votre passerelle vers une planification et une organisation sans faille.",
